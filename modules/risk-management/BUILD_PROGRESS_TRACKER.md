...
yet Architecture contains work (`architecture.md`, `capabilities/`). App Description must be
...
**Status**: [ ] NOT_STARTED  
**Location**: `modules/risk-management/01-ux-workflow-wiring-spec/`  
**Key Artifacts**:
...
**Status**: [ ] NOT_STARTED  
**Location**: `modules/risk-management/02-frs/`  
**Key Artifacts**:
...
**Status**: [ ] NOT_STARTED  
**Location**: `modules/risk-management/03-trs/`  
**Key Artifacts**:
...
**Status**: [ ] IN_PROGRESS  
**Location**: `modules/risk-management/04-architecture/`  
**Key Artifacts**:
...
**Completion Date**: N/A  
**Notes**: Architecture is in progress. `architecture.md` and `capabilities/` exist. Formal
gate-pass requires upstream stages to be completed first. Mapped from old Stage 2.

---

### Stage 6: QA-to-Red
**Status**: [ ] NOT_STARTED  
**Location**: `modules/risk-management/05-qa-to-red/`  
**Key Artifacts**:
...
**Status**: [ ] NOT_STARTED  
**Location**: `modules/risk-management/06-pbfag/`  
**Key Artifacts**:
...
**Status**: [ ] NOT_STARTED  
**Location**: `modules/risk-management/07-implementation-plan/`  
**Key Artifacts**:
...
**Status**: [ ] NOT_STARTED  
**Location**: `modules/risk-management/08-builder-checklist/`  
**Key Artifacts**:
...
**Status**: [ ] NOT_STARTED  
**Location**: `modules/risk-management/09-iaa-pre-brief/`  
**Key Artifacts**:
...
**Status**: [ ] NOT_STARTED  
**Location**: `modules/risk-management/10-builder-appointment/`  
**Key Artifacts**:
...
**Status**: [ ] NOT_STARTED  
**Location**: `modules/risk-management/11-build/`  
**Key Artifacts**:
...
**Next Steps**:
1. Create `app-description.md` in `modules/risk-management/00-app-description/`
