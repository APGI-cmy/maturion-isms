...
| ISMS-MMM-RED-003 | ISMS public/marketing path | Non-entitled user | Open Maturity Roadmap public overview | User is sent to MMM runtime before entitlement/acquisition | User stays on ISMS-owned marketing/subscription path |
| ISMS-MMM-RED-004 | Boundary discipline | Any | Inspect diff | ISMS implements MMM runtime behavior | ISMS changes only routing/handoff behavior; MMM runtime untouched |
