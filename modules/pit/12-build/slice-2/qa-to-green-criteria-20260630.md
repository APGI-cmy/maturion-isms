...
| PIT-S12S2-GREEN-004 | Create Project | `/projects/new` renders a PIT Create Project foundation, not a generic-only placeholder shell. | Browser screenshot |
...
4. `/projects/new` Create Project foundation screenshot;
5. incognito direct-route negative evidence;
6. PIT host redirect evidence;
7. statement that no ISMS-owned surfaces were changed unless explicitly authorized;
8. final QP/IAA/CS2 disposition for Slice 2.
