...
It also clarifies the approval-workflow foundation state and identifies the next lawful runtime wave.
...
## 9. Next Lawful Runtime Wave

The next product implementation issue must be titled and scoped around:
...
### 9.4 Non-Scope for the Foundation Wave
...
- approval workflow foundation runtime is the next governed MMM build lane.