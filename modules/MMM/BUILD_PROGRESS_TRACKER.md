...
- **2026-06-03 — VERBATIM Criteria Generation Falls Back To Hybrid/Generic Wording**
  ...
  - **Root Cause**: The criteria stage had not yet been upgraded to the same source-faithful extraction precedence as intent generation; it trusted proposed criteria as uploaded source without verifying the wording against `ai_knowledge`. The first source-chunk criteria path also combined all chunk-positive VERBATIM source documents instead of selecting the primary/newest usable source row.
