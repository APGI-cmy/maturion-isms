# FAIL-ONLY-ONCE Registry — ui-builder
...
This registry records governance failures that ui-builder must never repeat. Each entry captures a
root cause, the permanent rule that prevents recurrence, and the incident reference.

ui-builder loads this file in Phase 1 on every session start and applies all rules.
...
The BOOTSTRAP DIRECTIVE is non-negotiable. If ui-builder reads any repo file before completing
