# Integration Builder — Canonical Governance References (Tier 2)

**Agent**: integration-builder
**Knowledge Version**: 1.0.0
**Last Updated**: 2026-03-04
**Migrated from**: Contract §"Canonical Governance References" (contract §4.3b migration)
...
- AGENT_HANDOVER_AUTOMATION.md v1.1.3 — Session closure (§4.3b artifact immutability)
