# FAIL-ONLY-ONCE Registry — integration-builder
...
This registry records governance failures that integration-builder must never repeat. Each entry captures a
root cause, the permanent rule that prevents recurrence, and the incident reference.

integration-builder loads this file in Phase 1 on every session start and applies all rules.
...
The BOOTSTRAP DIRECTIVE is non-negotiable. If integration-builder reads any repo file before completing
