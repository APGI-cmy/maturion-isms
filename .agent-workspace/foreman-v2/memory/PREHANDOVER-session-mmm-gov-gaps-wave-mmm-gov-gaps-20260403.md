...
- **iaa_audit_token**: `IAA-session-mmm-gov-gaps-20260403-R4-PASS` (R4 final token — supersedes R3; R4 issued to cover post-R3 review comment fixes)
...
- [x] IAA audit token: PASS (token reference: `IAA-session-mmm-gov-gaps-20260403-R4-PASS` — R4 final token; R3 superseded by R4 after review comment fixes)
