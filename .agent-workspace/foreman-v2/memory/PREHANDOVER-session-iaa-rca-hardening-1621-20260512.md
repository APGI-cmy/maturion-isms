...
4. `.agent-workspace/independent-assurance-agent/knowledge/iaa-category-overlays.md` v4.4.0→4.5.0
5. `.agent-workspace/independent-assurance-agent/knowledge/index.md` v4.0.0→4.1.0
6. `.agent-workspace/qa-builder/knowledge/index.md` v1.1.0→1.2.0
7. `.agent-workspace/root-cause-corrective-action-agent/knowledge/index.md` v1.0.0→1.1.0
8. `.agent-workspace/root-cause-corrective-action-agent/knowledge/rca-operating-guidance.md` v1.0.0→1.1.0
9. `.agent-workspace/root-cause-corrective-action-agent/knowledge/rca-trigger-checklist.md` v1.0.0→1.1.0
10. `.github/scripts/rca-trigger-detector.js`
11. `.github/scripts/rca-trigger-detector.test.sh`
12. `.github/scripts/validate-product-delivery-gates.sh`
13. `.github/scripts/validate-product-delivery-gates.test.sh`
