...
ceremony_admin_appointed: NOT_YET
...
| T-3 | Tier 2/Tier 3 RCA operational artifacts | governance-liaison-isms-agent | 🟢 DONE | `.agent-workspace/governance-liaison-isms/knowledge/rca-operational-guidance.md`, `governance/templates/*RCA*` |
| T-4 | PR governance hygiene artifacts for preflight gates | foreman-v2-agent | 🟡 IN PROGRESS | scope declarations + IAA wave record |
