...
| T1 | Add AAP-21 (active-tracker contradiction anti-pattern) | governance-liaison-isms-agent | ✅ COMPLETE — session-067-20260419 |
| T2 | Add ACR-15 (active-tracker IAA rejection trigger) | governance-liaison-isms-agent | ✅ COMPLETE — session-067-20260419 |
| T3 | Add ECAP checklist row for active tracker normalization | governance-liaison-isms-agent | ✅ COMPLETE — session-067-20260419 |
| T4 | Define "active control artifact" boundary in canon | governance-liaison-isms-agent | ✅ COMPLETE — defined in AAP-21 / ACR-15 |
| T5 | Update PREHANDOVER template with active tracker normalization | governance-liaison-isms-agent | ✅ COMPLETE — session-067-20260419 |
| T6 | Update CANON_INVENTORY.json for all modified files | governance-liaison-isms-agent | ✅ COMPLETE — IAA canon v1.9.0, hash recomputed |
| T7 | Add A-039 to Foreman FAIL-ONLY-ONCE.md | foreman-v2-agent | ✅ COMPLETE |
| T8 | Add D-2 to wave-reconciliation-checklist.md | foreman-v2-agent | ✅ COMPLETE |
...
| Governance-liaison QP PASS | ✅ COMPLETE — session-067-20260419 |
