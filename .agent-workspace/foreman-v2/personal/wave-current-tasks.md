...
iaa_prebrief_path: .agent-admin/assurance/iaa-prebrief-dckis-cl5d2.md
task_cl5d2_d1_architecture_review: IN_PROGRESS
task_cl5d2_d2_cep_update: PENDING
tasks_done: 0
tasks_total: 2
...
|---|------|----------------|----------------|--------|---------|
| T-CL5D2-D1 | Produce architecture review document for process-document-v2 re-hosting | CL5D2-D1 | api-builder | 🟡 IN PROGRESS | — |
| T-CL5D2-D2 | Update AIMC_LKIAC_COMBINED_EXECUTION_PLAN.md — record CL-5-D2 COMPLETE + CL-5 COMPLETE | CL5D2-D2 | api-builder | 🔴 PENDING | — |
...
| Handover | PENDING — awaiting api-builder delivery | — |
