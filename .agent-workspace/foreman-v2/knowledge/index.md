...
| `FAIL-ONLY-ONCE.md` | **PREFLIGHT §1.3** — Breach registry, Universal A-rules (ISMS-local namespace A-001+), incident log, open improvements; must be self-attested every session before any work begins | 2.9.0 |
...
**Authority**: FAIL-ONLY-ONCE v2.9.0 (A-010, A-014, A-015, A-016, A-031)  
