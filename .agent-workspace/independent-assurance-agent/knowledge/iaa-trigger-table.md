...
| 2.6.0 | 2026-05-10 | PRODUCT_BUILD_ASSURANCE trigger category added (issue #1590): product-facing BUILD/T2 or functional-delivery-claim PRs now require mandatory loading of PRODUCT_BUILD_ASSURANCE_STANDARD.md before verdict; decision flow updated with explicit product-build classification step. |
