...
| 4.3.0 | 2026-05-14 | issue #1635 downstream sync completion: iaa-trigger-table.md → v2.7.0 updated PRE_BUILD_GATES references from OVL-PBG-001..017 to OVL-PBG-001..019 in PRE_BUILD_STAGE_MODEL trigger row and classification step 8 (OVL-PBG-ADM-002 compliance). |
