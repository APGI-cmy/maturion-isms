...
| `FAIL-ONLY-ONCE.md` | Permanent rules recording governance failures IAA must never repeat | 1.8.0 | PRESENT — Rules A-001 through A-025 active (A-025: ceremony artifacts must use PENDING until Post-ASSURANCE-TOKEN ceremony) |
