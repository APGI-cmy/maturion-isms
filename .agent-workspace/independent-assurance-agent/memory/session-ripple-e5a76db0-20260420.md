...
- pr_reviewed: #1432 — "Update governance artifacts for distribution" (governance-liaison-isms session-068)
- overlay_applied: LIAISON_ADMIN (KNOWLEDGE_GOVERNANCE overlay per trigger table)
- verdict: ASSURANCE-TOKEN — IAA-session-068-wave-ripple-e5a76db0-20260420-PASS
