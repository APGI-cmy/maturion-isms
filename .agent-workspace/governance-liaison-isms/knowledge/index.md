...
| `rca-operational-guidance.md` | **RCA Operating Guide** — Trigger handling, lowest-effective-layer routing, and discoverability pointers for RCA/continuous-improvement execution | 1.0.0 |
...
| 1.8.0 | 2026-05-10 | governance-liaison-isms | Added `rca-operational-guidance.md` Tier 2 operational guidance and discoverability pointers for RCA/continuous-improvement layer-down. |
