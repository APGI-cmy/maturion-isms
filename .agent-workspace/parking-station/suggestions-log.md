...
| 2026-02-24 | governance-liaison-isms | session-019 | APP_STARTUP_REQUIREMENTS.md was missing for MAT module — created and all four compliance gaps (CG-001 through CG-004) from platform standards audit resolved in single PR | session-019-20260224.md |
