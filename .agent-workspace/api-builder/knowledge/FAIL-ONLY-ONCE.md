# FAIL-ONLY-ONCE Registry — api-builder
...
This registry records governance failures that api-builder must never repeat. Each entry captures a
root cause, the permanent rule that prevents recurrence, and the incident reference.

api-builder loads this file in Phase 1 on every session start and applies all rules.
...
The BOOTSTRAP DIRECTIVE is non-negotiable. If api-builder reads any repo file before completing
