...
- **Canonical Authorities**: BUILD_PHILOSOPHY.md, governance/ROLE_APPOINTMENT_PROTOCOL.md, foreman/builder/integration-builder-spec.md
...
- **Builder Spec**: foreman/builder/integration-builder-spec.md
...
- **Repository**: APGI-cmy/maturion-isms
- **Type**: consumer-repository
- **Read Access**: foreman/**, architecture/**, governance/**, apps/*/api/**, apps/*/integrations/**
- **Write Access**: apps/*/integrations/**, .agent-workspace/integration-builder/**
- **Escalation Required**: .github/agents/**, .github/workflows/**, BUILD_PHILOSOPHY.md, governance/canon/**

### Capabilities
**Builder Operations**: integration, api-contract-validation, inter-module-endpoints, override-analysis
...
**Version**: 3.0.0 | **Date**: 2026-02-14 | **Status**: Active | **Recruited**: 2026-02-14 (Wave 5)
...
Implement inter-module integration endpoints (PIT export, Maturity Roadmap export), API contract validation, and override analysis pipeline from frozen architecture to make QA-to-Red tests GREEN.
...
**Capabilities**: Next.js Edge Functions, OpenAPI contract validation, VCR pattern for testing, integration error handling  
...
## Integration-Builder Specific Requirements
...
1. **Implement PIT export endpoint** per `modules/mat/02-architecture/integration-architecture.md`:
...
**Complete When**: Scope matches arch, 100% QA green (all 4 integration tests), gates satisfied, evidence ready, zero debt/warnings, build succeeds, integration tests pass, error handling tested, reports submitted  
...
**File**: `.agent-workspace/integration-builder/memory/session-NNN-YYYYMMDD.md`
...
**Line Count**: ~230 lines (excluding YAML) | **References**: See governance.bindings + foreman/builder/integration-builder-spec.md
