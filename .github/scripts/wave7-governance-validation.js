...
const policyScenarios = [
  { id: 'S1-foreman-only-governance-doc-change-no-implementation-files', expected: 'PASS', files_changed: ['.agent-admin/control/overlays/example.md'], claim_text: 'governance documentation update; no handover claim', iaa_prebrief_ready: true, builder_delegation_recorded: false, delegation_precedes_implementation: false, handover_allowed_exists: false, handover_allowed_head_matches: false, handover_allowed_true: false, ecap_required: false, ecap_admin_validated: false, required_checks_green: true },
  { id: 'S2-builder-implementation-change-valid-prebrief-and-ordered-delegation', expected: 'PASS', files_changed: ['src/service.ts'], claim_text: 'implementation evidence only; no handover claim yet', iaa_prebrief_ready: true, builder_delegation_recorded: true, delegation_precedes_implementation: true, handover_allowed_exists: false, handover_allowed_head_matches: false, handover_allowed_true: false, ecap_required: false, ecap_admin_validated: false, required_checks_green: true },
  { id: 'S3-implementation-change-missing-builder-delegation', expected: 'FAIL', files_changed: ['src/service.ts'], claim_text: 'implementation evidence only; no handover claim yet', iaa_prebrief_ready: true, builder_delegation_recorded: false, delegation_precedes_implementation: false, handover_allowed_exists: false, handover_allowed_head_matches: false, handover_allowed_true: false, ecap_required: false, ecap_admin_validated: false, required_checks_green: true },
  { id: 'S4-implementation-change-retroactive-delegation', expected: 'FAIL', files_changed: ['src/service.ts'], claim_text: 'implementation evidence only; no handover claim yet', iaa_prebrief_ready: true, builder_delegation_recorded: true, delegation_precedes_implementation: false, handover_allowed_exists: false, handover_allowed_head_matches: false, handover_allowed_true: false, ecap_required: false, ecap_admin_validated: false, required_checks_green: true },
...
const realGateRuns = [
  ...
  () => runPrehandoverFixture('G4-handover-missing-control', 'missing-control', 'FAIL'),
  () => runPrehandoverFixture('G5-handover-stale-control', 'stale-control', 'FAIL'),
  () => runPrehandoverFixture('G6-ecap-required-admin-validation-missing', 'ecap-missing', 'FAIL'),
  () => runEcapFixture('G7-ecap-valid-admin-output', 'valid', 'PASS'),
  () => runEcapFixture('G8-ecap-readiness-overstep-output', 'overstep', 'FAIL'),
  () => expectGate('G9-merge-required-check-alignment-current-branch', run('node', [scriptPaths.mergeAlignment], { cwd: repoRoot, env: { WAVE6_ALIGNMENT_SELF_TEST: '1' } }), 'PASS'),
];
