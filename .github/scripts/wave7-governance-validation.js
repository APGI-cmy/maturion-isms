...
const policyScenarios = [
  ...
  { id: 'S2-builder-implementation-change-valid-prebrief-and-ordered-delegation', expected: 'PASS', files_changed: ['src/service.ts'], claim_text: 'implementation evidence recorded only', iaa_prebrief_ready: true, builder_delegation_recorded: true, delegation_precedes_implementation: true, handover_allowed_exists: false, handover_allowed_head_matches: false, handover_allowed_true: false, ecap_required: false, ecap_admin_validated: false, required_checks_green: true },
  { id: 'S3-implementation-change-missing-builder-delegation', expected: 'FAIL', files_changed: ['src/service.ts'], claim_text: 'implementation evidence recorded only', iaa_prebrief_ready: true, builder_delegation_recorded: false, delegation_precedes_implementation: false, handover_allowed_exists: false, handover_allowed_head_matches: false, handover_allowed_true: false, ecap_required: false, ecap_admin_validated: false, required_checks_green: true },
  { id: 'S4-implementation-change-retroactive-delegation', expected: 'FAIL', files_changed: ['src/service.ts'], claim_text: 'implementation evidence recorded only', iaa_prebrief_ready: true, builder_delegation_recorded: true, delegation_precedes_implementation: false, handover_allowed_exists: false, handover_allowed_head_matches: false, handover_allowed_true: false, ecap_required: false, ecap_admin_validated: false, required_checks_green: true },
