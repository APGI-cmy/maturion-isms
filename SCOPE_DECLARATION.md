# Scope Declaration — wave15r-gov — 2026-03-08

**Wave**: wave15r-gov
**Branch**: copilot/update-governance-orchestration-wave15
**Session**: session-wave15r-gov-20260308
**PR**: Governance only — Wave 15 failure documentation + Wave 15R orchestration plan
**Authority**: CS2 (Johan Ras / @APGI-cmy) — issue #996

## Scope

This PR contains ONLY governance and planning documentation changes. No production code, schemas, migrations, or tests are written by the Foreman.
...
- `modules/mat/00-app-description/app-description.md` - §6.2 production gap annotation (v1.5)
- `modules/mat/01-frs/functional-requirements.md` - FR-005 + FR-103 annotated not satisfied (v2.1.0)
- `modules/mat/01.5-trs/technical-requirements-specification.md` - TR-037 annotated not verified (v1.9.0)
- `modules/mat/03-implementation-plan/implementation-plan.md` - Wave 15 FAILED + Wave 15R plan
- `modules/mat/BUILD_PROGRESS_TRACKER.md` - INC-WAVE15-PARSE-001 section (v1.7)
