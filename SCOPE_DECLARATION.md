...
| `.agent-admin/assurance/iaa-token-session-cep-v1.8.0-programme-clearance-20260403.md` | NEW | IAA token file (REJECTION-PACKAGE — re-invocation pending) |
...
| `.agent-workspace/independent-assurance-agent/memory/session-cep-v1.8.0-programme-clearance-20260403.md` | NEW | IAA session memory |
