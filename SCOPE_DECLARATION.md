...
- `.agent-admin/assurance/iaa-token-session-050-wave1-20260305.md` - IAA assurance token (written by IAA)
- `.agent-workspace/independent-assurance-agent/memory/session-149-20260305.md` - IAA session memory (written by IAA)
- `SCOPE_DECLARATION.md` - This file (updated from prior PR scope to session-050 scope per A-026/A-028 compliance)
