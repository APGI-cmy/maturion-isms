...
| `maturion-advisor` | Maturion | Maturion Enterprise AI Advisor — enterprise security, operational maturity, and ISMS governance across all six maturity domains | 1.0.0 | ACTIVE | IDLE ⚠️ | 2026-03-01 | CS2 |
...
|---|---|---|---|---|
| 1.1.0 | 2026-03-01 | `governance-liaison-isms-agent` | LKIAC Wave 1 | Added `maturion-advisor` to §2 Persona Registry (row 9 — Maturion Enterprise AI Advisor, IDLE, module wiring pending) |
