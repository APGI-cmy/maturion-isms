...
- [ ] **Wave Completion Gate**: Verifies physical deliverables exist and work before closure; validates functional completeness, quality standards (100% GREEN tests, zero test debt, all TRS quality standards met, successful build), evidence bundle; non-delegable FM authority (`governance/canon/FULLY_FUNCTIONAL_DELIVERY_STANDARD.md` Section 5.2).
