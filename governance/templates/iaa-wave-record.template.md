...
- VERDICT: {FULL_FUNCTIONAL_DELIVERY / PARTIAL_FUNCTIONAL_DELIVERY / UI_SHELL_ONLY / ADMIN_ONLY / FAIL}
- FULL_FUNCTIONAL_DELIVERY_VERDICT: {FULL_FUNCTIONAL_DELIVERY / PARTIAL_FUNCTIONAL_DELIVERY / UI_SHELL_ONLY / ADMIN_ONLY / FAIL} # optional alias for compatibility
...
- CALIBRATION_REFERENCE: {APGI-cmy/maturion-isms#1553 (OC-009) when PARTIAL_FUNCTIONAL_DELIVERY or UI_SHELL_ONLY is issued}
