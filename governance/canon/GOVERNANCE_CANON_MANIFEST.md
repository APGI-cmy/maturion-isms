...
| `GOVERNANCE_WATCHDOG_CANON.md` | 1.0.1 | PUBLIC_API | All Repos | 2026-03-21 |
...
These policies are located in `governance/policy/` and establish constitutional governance rules that apply across all repositories.
