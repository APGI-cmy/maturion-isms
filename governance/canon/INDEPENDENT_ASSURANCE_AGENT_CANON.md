...
**Amended**: 2026-04-21 — v1.11.0: Added ACR-17 (wrong-but-existing reference + renumber/rebase drift) to §Admin-Ceremony Rejection Triggers; updated §Admin-Ceremony Rejection Triggers header; authority: CS2 — wave admin-ceremony-hardening-20260421 (maturion-isms#[issue]).  
