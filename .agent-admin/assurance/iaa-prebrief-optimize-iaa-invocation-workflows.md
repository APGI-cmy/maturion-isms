...
| **HFMC-02 (SCOPE_DECLARATION parity)** | SCOPE_DECLARATION.md not updated for current wave before T6 invocation | Foreman MUST update `.agent-workspace/foreman-v2/personal/SCOPE_DECLARATION.md` from current wave reference (iaa-12stage-upgrade) to `optimize-iaa-invocation-workflows` and list all committed artifacts before T6. |
