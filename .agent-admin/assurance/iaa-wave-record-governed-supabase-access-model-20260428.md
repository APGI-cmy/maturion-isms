...
**HEAD SHA reviewed**: e778496cd18d8ae28a7aea811be2201465655bfb
...
| `990c47b` | iaa: refresh assurance token to HEAD cf20e63 — log_verification_call fail-closed + contextual RAISE | Governance artifact only — no code change. ✅ PASS |
| `e2c7141` | [Ripple] Propagate governance layer-down (#1517) | Governance propagation from main — no code change to this PR's deliverables. ✅ PASS |
| `e778496` | Merge branch 'main' into copilot/add-supabase-migration-verification-model | Merge commit — resolves any main-branch changes; no substantive code change to this PR's deliverables. ✅ PASS |
...
- **PR**: maturion-isms#1506
- **Issue**: maturion-isms#1505
- **Reviewed SHA**: e778496cd18d8ae28a7aea811be2201465655bfb
- **Wave**: governed-supabase-access-model-20260428
- **Token reference**: IAA-session-078-governed-supabase-access-model-20260429-PASS

All 36 checks PASS (plus post-`5c657f6` coverage addendum: 9 commits reviewed and verified — see POST-ORIGINAL-SHA COVERAGE section below). Merge gate parity: PASS.
