...
EXPECTED_QA_SCOPE:
- `.admin/prs/pr-1794.json` (per-PR admin manifest)
- `.agent-admin/prs/pr-1794/wave-current-tasks.md` (per-PR wave task record)
- `.agent-admin/scope-declarations/pr-1794.md` (per-PR scope declaration)
- `.agent-admin/scope-declarations/pit-stage12-w82-final-verification.md` (wave-start scope declaration)
- `.agent-admin/builder-appointments/pit-stage12-w82-final-verification-builder-task.md` (bounded builder task order with explicit Supabase seed block)
...
- `.agent-admin/ecap/pit-stage12-w82-final-verification-ecap.md` (ECAP expected-administration record marked pending builder handover)
- `modules/pit/12-build/w82-final-role-matrix-denied-path-evidence.md` (evidence ledger with TODO tables for all required W8.2 verification items)
...
- Keep PR as not merge-ready until Foreman/QP evaluates after builder handover
...
- ECAP_EXPECTED_ARTIFACTS: `.admin/prs/pr-1794.json`, `.agent-admin/prs/pr-1794/wave-current-tasks.md`, `.agent-admin/scope-declarations/pr-1794.md`, `.agent-admin/scope-declarations/pit-stage12-w82-final-verification.md`, `.agent-admin/builder-appointments/pit-stage12-w82-final-verification-builder-task.md`, `.agent-admin/assurance/iaa-wave-record-pit-stage12-w82-final-verification-2026-06-11.md`, `.agent-admin/ecap/pit-stage12-w82-final-verification-ecap.md`, `modules/pit/12-build/w82-final-role-matrix-denied-path-evidence.md`

CURRENT_HEAD_CI_EXPECTATIONS:
- Preflight evidence/admin parity gates must see active wave-record binding for PR #1794
- Scope declaration parity must match the exact eight-file changed-file set for this wave
- IAA final assurance: no implementation delivery claim is made in this wave
- No migration, application code, workflow, or agent-contract changes expected in diff
...
IAA_WILL_QA:
- Scope declarations include all expected files in FILES_CHANGED and correct IN_SCOPE/OUT_OF_SCOPE boundaries
