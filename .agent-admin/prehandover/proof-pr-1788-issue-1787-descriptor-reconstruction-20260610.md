...
- IAA review: .agent-admin/assurance/iaa-review-issue-1787-descriptor-reconstruction.md
...
The package is now traceable. This proof does not approve merge. Fresh CI must run on the latest head and Foreman must inspect final check status before the PR leaves draft.
