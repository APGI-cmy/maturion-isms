...
outstanding_transition_limitations:
  ...
  limitations:
    ...
    - id: W4-ECAP-SCHEMA-VALIDATION-NOT-FULLY-ENFORCED
      ...
      planned_resolution_wave: "7-final-review"
      blocking_before_final_merge: true
    ...
    - id: W6-BRANCH-PROTECTION-CONFIRMATION
      ...
      description: "Wave 6 validates repository-file alignment, but does not query GitHub branch-protection required-check configuration. Branch protection confirmation is required before draft exit/final merge readiness, unless CS2 explicitly accepts repository-file alignment as the transition basis."
      planned_resolution_wave: "7-final-review"
      blocking_before_final_merge: true
  resolved_for_wave_progression:
    - id: W2-MERGE-GATE-INVENTORY-DEFERRED
      ...
      resolution_scope: "Wave 6 progression; Wave 7 validates behavior."
    ...
    - id: W6-LEGACY-EXTERNAL-CHECK-BEHAVIOR-VALIDATION
      resolved_by:
        - ".agent-admin/control/wave-reviews/wave-7-validation-evidence.md"
        - ".github/scripts/wave7-governance-validation.js"
        - ".github/workflows/wave7-governance-validation.yml"
      resolution_scope: "Wave 7 real-gate validation; final review must still confirm CI and draft-exit posture."
    - id: W6-CWT-EVIDENCE-MISSING
      resolved_by:
        - ".agent-admin/control/wave-reviews/wave-6-cwt-evidence.md"
        - ".github/scripts/merge-gate-required-checks-alignment.js"
        - ".github/workflows/merge-gate-required-checks-alignment.yml"
      resolution_scope: "Wave 6 progression; Wave 7 validates end-to-end behavior."
    ...
    - id: W5-TIER1-CONTROL-FIDELITY-REVIEW-PENDING
      resolved_by:
        ...
        - ".agent-admin/control/wave-reviews/wave-5-foreman-contract-impact-review.md"
      resolution_scope: "Wave 5 progression only; Wave 7 validates end-to-end scenarios."
```
