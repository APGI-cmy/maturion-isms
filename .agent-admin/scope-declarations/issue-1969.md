...
Restore the missing Foreman Tier 2 session-memory template and ensure the wake-up/bootstrap path fails nonzero whenever any Tier 2 file declared as required by the active agent contract is missing.
