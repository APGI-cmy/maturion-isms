...
5. `apps/mat-ai-gateway/services/public_chat.py`
6. `apps/mat-ai-gateway/services/apw_specialist_stubs.py`
7. `apps/mat-ai-gateway/tests/test_public_chat.py`
8. `apps/mat-ai-gateway/tests/test_apw_specialist_red_stubs.py`
...
This PR intentionally avoids `.agent-admin/control/delegation-order.json` unless a required gate explicitly forces it, because that artifact caused repeated admin-loop conflicts in earlier waves.
