...
PR_NUMBER: 1624
ISSUE: #1623 — Add mandatory PIT Live Functional Verification package before QA-to-Red / build handover
Governing-Issue: #1623
...
FREEZE_AUTHORITY: foreman-v2-agent (POLC mode, issue #1623)
