...
DATE_UTC: 2026-09-20
STATUS: ECAP_ADMIN_HANDOFF_PREPARED
RESPONSIBILITY_DOMAIN: PR-scoped administrative bundle preparation for the GOV-2047 Foreman/IAA/controller hardening wave without IAA invocation or readiness substitution.
...
- Preserve the already-committed GOV-2047 governance/controller surfaces exactly as reviewed; ECAP does not alter their substance.
- Normalize PR-scoped tracker appointment metadata and point it at the ECAP bundle path.

OUT_OF_SCOPE:
- Any IAA invocation, ASSURANCE-TOKEN, REJECTION-PACKAGE, or verdict-writing.
- Any substantive readiness, merge, or CS2 approval claim by ECAP.
