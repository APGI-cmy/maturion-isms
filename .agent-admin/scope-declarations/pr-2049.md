...
DATE_UTC: 2026-09-20
STATUS: FOREMAN_ASSURANCE_HANDOFF_IN_PROGRESS
RESPONSIBILITY_DOMAIN: Final PR-scoped Foreman assurance handback for the GOV-2047 hardening wave, preserving stable reviewed-head binding while adding PREHANDOVER/session evidence and final IAA/token handoff artifacts only.
...
- FINAL_IAA_STEP: FOREMAN_OWNED_PENDING
