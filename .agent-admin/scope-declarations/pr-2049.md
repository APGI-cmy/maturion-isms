...
- Keep the existing Foreman PREHANDOVER/session artifacts and the historical IAA wave record in place while accurately preserving historical tokens and recording the refreshed current-head final PASS for the terminal-state safety correction set.
