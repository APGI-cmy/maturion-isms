...
**Status:** IAA R3 F-005 OPTIONAL-PIPE CORRECTED / QP R5 PASS / ECAP R5 ADMIN_VALIDATED / FINAL IAA PENDING
**CS2:** Johan Ras
...
| GOV-1969-03 | Add executable happy-path, populated-memory, missing-control and absent-list compatibility regression coverage | GOVERNANCE_QA | COMPLETE — 4 focused scenarios PASS; Wave 7 11/11 policy and 27/27 real gates PASS |
| GOV-1969-04 | Bind QP, ECAP, CI and independent final IAA evidence to the frozen PR head | ASSURANCE | IN PROGRESS — IAA R3 rejection recorded at `d560c0ef…`; optional-pipe F-005 correction at `ff146314…`; QP R5 PASS; ECAP R5 ADMIN_VALIDATED; final IAA pending |
...
| GOV-1969-06 | Repair prehandover false-positive detection without weakening positive-claim enforcement | CI_WORKFLOW / GOVERNANCE_CONTROL_REPAIR | COMPLETE — semantic correction at `a1baaaa8…`; JSON/Markdown correction at `719c5e76…`; optional-pipe correction at `ff146314…`; QP R5 PASS |
