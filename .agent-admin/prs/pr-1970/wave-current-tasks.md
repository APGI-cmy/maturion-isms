...
**Status:** IAA R3 F-005 OPTIONAL-PIPE CORRECTED / QP R5 PASS / ECAP R5 AND FINAL IAA PENDING
**CS2:** Johan Ras
...
| GOV-1969-04 | Bind QP, ECAP, CI and independent final IAA evidence to the frozen PR head | ASSURANCE | IN PROGRESS — IAA R3 rejection recorded at `d560c0ef…`; optional-pipe F-005 correction at `ff146314…`; QP R5 PASS; ECAP R5 and final IAA pending |
